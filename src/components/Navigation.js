...
import { Menu, X, Rocket, Users, BookOpen, Microscope, Briefcase, Github, Mail } from 'lucide-react';
            ...
            <div className="px-4 py-4 space-y-2">
              {navItems.map((item) => (
                <motion.button
                  ...
                  whileHover={{ x: 10 }}
                  onClick={() => scrollToSection(item.href)}
                  className="flex items-center space-x-3 w-full text-left p-3 rounded-lg hover:bg-primary-500/10 transition-colors duration-200"
                >
